...
namespace Binjyo
{
    internal static class AppContextMenuFactory
    {
        ...
        public static MenuItem CreateTrayMenuRoot(App app, bool includeExit = true, bool includeCanvasWindow = true)
        {
            ...
            createItem.Items.Add(CreateMenuItem("Explorer Dynamic", null, (s, e) => app.CreateExplorerCaptureMemoDynamic()));
            createItem.Items.Add(CreateMenuItem("Explorer Static", null, (s, e) => app.CreateExplorerCaptureMemoStatic()));
